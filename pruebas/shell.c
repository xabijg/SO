            ...
            *c = *c+1;
            ...
            if (strcmp(trozos[0], "authors") == 0) {
                ...
                if ( trozos[1] == NULL ) {
                    ...
                    else if ( strcmp(trozos[2], "-malloc") == 0 ) { Cmd_DeallocMalloc ( trozos[3], memoryFeed); }
                    else if ( strcmp(trozos[2], "-mmap") == 0 ) { Cmd_DeallocMmap( trozos[3], memoryFeed ); }
                    else if ( strcmp(trozos[2], "-shared") == 0 ) { Cmd_DeallocShared(trozos[3], memoryFeed); }
                    else { Cmd_DeallocAddress ( trozos[2], memoryFeed ); }
                ...
                dump(trozos[1], trozos[2]);

            } else if (strcmp(trozos[0], "memfill") == 0) {

                fill(trozos[1], trozos[2], trozos[3]);
